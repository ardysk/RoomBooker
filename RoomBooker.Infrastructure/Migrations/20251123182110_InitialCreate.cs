    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MaintenanceWindows", x => x.BlockId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Reservations_Users_ApprovedBy",
            ...
            migrationBuilder.InsertData(
                table: "Rooms",
                columns: new[] { "RoomId", "Capacity", "EquipmentDescription", "IsActive", "Name" },
                values: new object[,]
                {
                    { 1, 20, "Projektor, tablica, nagłośnienie", true, "Sala Konferencyjna A" },
                    { 2, 12, "Monitor, tablica suchościeralna", true, "Sala 101" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Reservations_ApprovedBy",
                table: "Reservations",
                column: "ApprovedBy");
