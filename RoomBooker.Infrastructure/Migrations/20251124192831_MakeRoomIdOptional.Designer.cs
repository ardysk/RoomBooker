...
namespace RoomBooker.Infrastructure.Migrations
{
    ...
    [Migration("20251124192831_MakeRoomIdOptional")]
    partial class MakeRoomIdOptional
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EquipmentReservation", b =>
                {
                    ...
                    b.HasKey("EquipmentsEquipmentId", "ReservationsReservationId");
            ...
            modelBuilder.Entity("RoomBooker.Core.Entities.Equipment", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            EquipmentId = 3,
                            Name = "Zestaw Video-Call",
                            RoomId = 1
                        },
                        new
                        {
                            EquipmentId = 4,
                            Name = "Telewizor 55 cali",
                            RoomId = 2
                        },
                        new
                        {
            ...
            modelBuilder.Entity("EquipmentReservation", b =>
                {
                    b.HasOne("RoomBooker.Core.Entities.Equipment", null)
                        .WithMany()
                        .HasForeignKey("EquipmentsEquipmentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("RoomBooker.Core.Entities.Reservation", null)
                        .WithMany()
